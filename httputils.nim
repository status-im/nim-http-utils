...
const
  ...
  responseSM = [
    ...
    0x8D, 0x8D, 0x8D, 0x8D, 0x8D, 0x8D, 0x8E, 0xC5, 0x8D, 0x8D, 0x8D, 0x0C, 0xCF, 0xCF, 0xCF, 0xCF, # s0c: 1st space
...
proc toHttpCode*(code: int): Opt[HttpCode] =
  ## Converts integer ``code`` to HttpCode value.
  case code
  of 100: Opt.some(Http100)
  of 101: Opt.some(Http101)
  of 200: Opt.some(Http200)
  of 201: Opt.some(Http201)
  of 202: Opt.some(Http202)
  of 203: Opt.some(Http203)
  ...
  of 303: Opt.some(Http303)
  of 304: Opt.some(Http304)
  of 305: Opt.some(Http305)
  of 307: Opt.some(Http307)
  of 400: Opt.some(Http400)
  of 401: Opt.some(Http401)
  of 403: Opt.some(Http403)
  of 404: Opt.some(Http404)
  of 405: Opt.some(Http405)
  of 406: Opt.some(Http406)
  of 407: Opt.some(Http407)
  of 408: Opt.some(Http408)
  of 409: Opt.some(Http409)
  of 410: Opt.some(Http410)
  of 411: Opt.some(Http411)
  of 412: Opt.some(Http412)
  of 413: Opt.some(Http413)
  of 414: Opt.some(Http414)
  of 415: Opt.some(Http415)
  of 416: Opt.some(Http416)
  of 417: Opt.some(Http417)
  of 418: Opt.some(Http418)
  of 421: Opt.some(Http421)
  of 422: Opt.some(Http422)
  of 426: Opt.some(Http426)
  of 428: Opt.some(Http428)
  of 429: Opt.some(Http429)
  of 431: Opt.some(Http431)
  of 451: Opt.some(Http451)
  of 500: Opt.some(Http500)
  of 501: Opt.some(Http501)
  of 502: Opt.some(Http502)
  of 503: Opt.some(Http503)
  of 504: Opt.some(Http504)
  of 505: Opt.some(Http505)
  else: Opt.none(HttpCode)
